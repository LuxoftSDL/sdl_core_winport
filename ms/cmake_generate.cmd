...
if %GEN_TYPE% == WinQt_x86 (
  set CMAKE_COMMAND=cmake -G %SDL_CMAKE_GENERATOR_NAME% -DCMAKE_INSTALL_PREFIX:PATH="%SDL_QT_DIR%\5.5\msvc2010" -DQT_PORT=1 -DBUILD_TESTS=on -DCMAKE_BUILD_TYPE=Debug %SDL_ROOT% 
